...
if (collect < global.totalcollect && collectstate == 0)
	collectstate = 1;
else if (collect > global.totalcollect && collectstate == 0)
	collectstate = 2;
...
{
	case 1:
		collect = Approach(collect, global.totalcollect, 0.35)
		
		if (collect >= global.totalcollect)
			collectstate = 0;
	break 
	
	case 2: 
		collect = Approach(collect, global.totalcollect, 5)
